...
@endsection
@section('content')
<div class="banner-header full-height valign bg-img bg-fixed" data-overlay-dark="5" data-background="{{ asset('public/front/img/slider/23.jpg') }}">
  <div class="container">
...
<section class="about section-padding" data-scroll-index="1">
  <div class="container">
      <div class="row">
          ...
          <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="{{ asset('public/front/img/about2.jpg') }}" alt="" class="mt-90 mb-30"> </div>
          <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="{{ asset('public/front/img/about.jpg') }}" alt=""> </div>
      </div>
  </div>
</section>
<!-- Services Box -->
...
<section class="about section-padding bg-darkbrown">
  <div class="container">
      <div class="row">
          <div class="col-md-5 mb-30 animate-box" data-animate-effect="fadeInLeft"> <img src="{{ asset('public/front/img/about3.jpg') }}" alt=""> </div>
          <div class="col-md-7 valign mb-30 animate-box" data-animate-effect="fadeInRight">
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="about-bottom"> <img src="{{ asset('public/front/img/signature.svg') }}" alt="" class="image about-signature">
  ...
  <div class="container">
      ...
      <div class="row">
          <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
              <div class="item">
                  <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/services/2.jpg') }}" alt=""> </div>
                  <div class="con">
          ...
          <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
              <div class="item">
                  <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/services/1.jpg') }}" alt=""> </div>
                  <div class="con">
          ...
          <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
              <div class="item">
                  <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/services/3.jpg') }}" alt=""> </div>
                  <div class="con">
...
<!-- Testimonials -->
<section class="background bg-img bg-fixed section-padding pb-0" data-background="{{ asset('public/front/img/slider/6.jpg') }}" data-overlay-dark="4">
  <div class="container">
      <div class="row">
          <!-- Testimonials -->
                  ...
                  <div class="testimonials-box">
                      <div class="owl-carousel owl-theme">
                          <div class="item"> <span>
                              ...
                              <div class="info">
                                  <div class="author-img"> <img src="{{ asset('public/front/img/team/1.jpg') }}" alt=""> </div>
                                  <div class="cont">
                          ...
                          <div class="item"> <span>
                              ...
                              <p>Lorem dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon sanleo nectan feugiat erat hendrerit necuis ve ante viventa miss sapien silver on the duiman lorem ipsum amet silver miss rana duru at finibus viverra neca the sene on satien.</p>
                              <div class="info">
                                  <div class="author-img"> <img src="{{ asset('public/front/img/team/2.jpg') }}" alt=""> </div>
                                  <div class="cont">
                          ...
                          <div class="item"> <span>
                              ...
                              <p>Lorem dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the lemon sanleo nectan feugiat erat hendrerit necuis ve ante viventa miss sapien silver on the duiman lorem ipsum amet silver miss rana duru at finibus viverra neca the sene on satien.</p>
                              <div class="info">
                                  <div class="author-img"> <img src="{{ asset('public/front/img/team/3.jpg') }}" alt=""> </div>
                                  <div class="cont">
      ...
      <div class="row">
          <div class="col-md-4">
              <div class="square-flip">
                  <div class="square bg-img" data-background="{{ asset('public/front/img/barber.jpg') }}">
          ...
          <div class="col-md-4">
              <div class="square-flip">
                  <div class="square bg-img" data-background="{{ asset('public/front/img/kids.jpg') }}">
                      <div class="square-container d-flex align-items-end justify-content-end">
                          <div class="box-title">
                              <h4>Kids Cuts</h4>
                          </div>
          ...
          <div class="col-md-4">
              <div class="square-flip">
                  <div class="square bg-img" data-background="{{ asset('public/front/img/team/b3.jpg') }}">
                      <div class="square-container d-flex align-items-end justify-content-end">
                          <div class="box-title">
...
<!-- Video -->
<section class="section-padding video-wrapper video bg-img bg-fixed" data-overlay-dark="4" data-background="{{ asset('public/front/img/slider/5.jpg') }}">
  <div class="container">
          ...
          <div class="col-md-12">
              <div class="owl-carousel owl-theme">
                  <div class="team-card mb-30">
                      <div class="team-img"><img src="{{ asset('public/front/img/team/b1.jpg') }}" alt="" class="w-100"></div>
                  ...
                  <div class="team-card mb-30">
                      <div class="team-img"><img src="{{ asset('public/front/img/team/b2.jpg') }}" alt="" class="w-100"></div>
                      <div class="team-content">
                  ...
                  <div class="team-card mb-30">
                      <div class="team-img"><img src="{{ asset('public/front/img/team/b3.jpg') }}" alt="" class="w-100"></div>
                      <div class="team-content">
                  ...
                  <div class="team-card mb-30">
                      <div class="team-img"><img src="{{ asset('public/front/img/team/b4.jpg') }}" alt="" class="w-100"></div>
                      <div class="team-content">
  ...
  <div class="container">
      ...
      <div class="row">
          <div class="col-md-12">
              <div class="owl-carousel owl-theme">
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/8.jpg') }}" alt="">
                          <div class="date">
                  ...
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/9.jpg') }}" alt="">
                          <div class="date">
                  ...
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/6.jpg') }}" alt="">
                          <div class="date">
                  ...
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/4.jpg') }}" alt="">
                          <div class="date">
                  ...
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/16.jpg') }}" alt="">
                          <div class="date">
                  ...
                  <div class="item">
                      <div class="position-re o-hidden"> <img src="{{ asset('public/front/img/slider/19.jpg') }}" alt="">
                          <div class="date">
...
<section class="testimonials">
  <div class="background bg-img bg-fixed section-padding pb-0" data-background="{{ asset('public/front/img/slider/20.jpg') }}" data-overlay-dark="6">
      <div class="container">
          <div class="row">
              <!-- Appointment call -->
          ...
          <div class="col-md-7">
              <div class="owl-carousel owl-theme">
                  <div class="clients-logo">
                      <a href="#0"><img src="{{ asset('public/front/img/clients/2.png') }}" alt=""></a>
                  </div>
                  <div class="clients-logo">
                      <a href="#0"><img src="{{ asset('public/front/img/clients/3.png') }}" alt=""></a>
                  </div>
                  <div class="clients-logo">
                      <a href="#0"><img src="{{ asset('public/front/img/clients/4.png') }}" alt=""></a>
                  </div>
                  <div class="clients-logo">
                      <a href="#0"><img src="{{ asset('public/front/img/clients/5.png') }}" alt=""></a>
                  </div>
                  <div class="clients-logo">
                      <a href="#0"><img src="{{ asset('public/front/img/clients/6.png') }}" alt=""></a>
                  </div>
              </div>
          </div>
      </div>
