...
<nav class="navbar navbar-expand-md">
    <div class="container">
        ...
        <div class="logo-wrapper">
            <!-- <a class="logo" href="index.html"> <img src="{{ asset('public/front/img/logo.png') }}" class="logo-img" alt=""> </a> -->
            <a class="logo" href="index.html"> <h2>DESI BRIVIBAS 132 <span>Barber Shop</span></h2> </a>
        </div>
        <!-- Button -->
